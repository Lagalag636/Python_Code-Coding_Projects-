...
class Room():
    def __init__(self, color, x, y):
        self.image.fill(color)
        self.rect = self.image.get_rect(topleft=(x, y)) #should I make this a list or draw it here? Maybe I should collect all of the shapes and/or sprites first and then draw it.
